...
import (
	...
	"github.com/andy2046/k8s-custom-resource-watch/pkg/client/clientset/versioned/scheme"
...
func (c *NokubeV1Client) CustomResources(namespace string) CustomResourceInterface {
	return newCustomResources(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*NokubeV1Client, error) {
	...
	return &NokubeV1Client{client}, nil
}

// NewForConfigOrDie creates a new NokubeV1Client for the given config and
...
func New(c rest.Interface) *NokubeV1Client {
	return &NokubeV1Client{c}
}
